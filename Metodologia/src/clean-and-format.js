...
// Formatar arquivo Markdown
function formatMarkdown(file) {
    return __awaiter(this, void 0, void 0, function* () {
        const content = fs.readFileSync(file, 'utf8');
        const cleanedContent = removeHtmlTags(content);
        const formatted = prettier.format(cleanedContent, { parser: 'markdown' });
        fs.writeFileSync(file, yield formatted);
    });
}
// Aplicar formatação a todos os arquivos Markdown
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        const files = yield (0, glob_promise_1.glob)('**/*.md', (err, files) => {
            if (err)
                throw err;
